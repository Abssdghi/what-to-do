...
function createCard(zIndex) {
  ...
  img.src = '/what-to-do/loading.webp' || 'https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExYWFibWQxNGc1bjF1d2l5amZna29sdzJpcW16OHlvN2xtbXo5bjc0diZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/aD7el9eHQ6qjBfeFdm/giphy.gif';
  
  const contentDiv = document.createElement('div');
  contentDiv.className = 'absolute bottom-0 w-full bg-gradient-to-t from-black via-black/60 to-transparent pt-12 pb-4 px-6 pb-9';
